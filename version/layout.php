        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-edit"></i> Recrutés <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">


                            <li><a href="contacts.php">Consulter les recrutés</a></li>
                            <li><a href="cv.php">Ajouter un cv </a></li>
                            <li><a href="fichentretien.php">Ajouter un entretient</a></li>
